...
# === CONFIGURATION ===
COLLECTOR_HOST = "__HOST_IP__"  # Replace with your streaming PC's IP
...
# === THRESHOLDS ===
BUFFER_DANGER_SEC = 3.0           # Buffer below this = pixelation risk
BUFFER_CRITICAL_SEC = 1.5         # Buffer below this = almost certain pixelation
...
def get_mpv_stats():
    ...
    dropped = mpv_get("vo-dropped-frame-count")
